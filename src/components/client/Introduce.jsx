            ...
            <div class="container">
                <div class="article">
                    <Row gutter={[15, 10]} >
                        ...
                        <Col span={24} xl={16} >
                            <div className="plyr plyr--video">
                                <div className='plyr__video-wrapper'>
                                    <video className='video-width' controls crossorigin playsinline poster="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg" id="player">
                                        ...
                                        <ul class="comments__list">
                                            ...
                                            <li class="comments__item comments__item--answer">
                                                ...
                                                <div class="comments__actions">
                                                    ...
                                                    <button type="button"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><polyline points='400 160 464 224 400 288' /><path d='M448,224H154C95.24,224,48,273.33,48,332v20' /></svg><span>Reply</span></button>
                                                    <button type="button"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><polyline points='320 120 368 168 320 216' /><path d='M352,168H144a80.24,80.24,0,0,0-80,80v16' /><polyline points='192 392 144 344 192 296' /><path d='M160,344H368a80.24,80.24,0,0,0,80-80V248' /></svg><span>Quote</span></button>
                                                </div>
                                            </li>
                                            ...
                                            <li class="comments__item comments__item--quote">
                                                ...
                                                <div class="comments__actions">
                                                    ...
                                                    <button type="button"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><polyline points='400 160 464 224 400 288' /><path d='M448,224H154C95.24,224,48,273.33,48,332v20' /></svg><span>Reply</span></button>
                                                    <button type="button"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><polyline points='320 120 368 168 320 216' /><path d='M352,168H144a80.24,80.24,0,0,0-80,80v16' /><polyline points='192 392 144 344 192 296' /></svg><span>Quote</span></button>
                                                </div>
                                            </li>
